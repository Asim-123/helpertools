...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Generate complete meta tags HTML code including OpenGraph and Twitter Card tags for your website.',
    category: 'seo',
  ...
  },
  {
    ...
    description: 'Generate JSON-LD schema markup for structured data to improve your search engine visibility.',
    category: 'seo',
  ...
  },
  {
    ...
    description: 'Check your website page speed and get recommendations to improve Core Web Vitals and performance.',
    category: 'seo',
  ...
  },
  {
    ...
    description: 'Check domain age and registration date to understand your website\'s history and SEO value.',
    category: 'seo',
